...
export class choose_party_untimed extends Component {
    componentDidMount() {
    ...
    <View style={styles.screen}>
            <ScrollView
                ...
                <TouchableOpacity style={styles.view3} onPress={() => this.props.navigation.navigate('Music')}>
...
export default choose_party_untimed; 
